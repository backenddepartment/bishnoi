        ...
        {!isSubmitted ? (
          <div id="modal-form">
            ...
            <form id="request-form" style={{ display: "flex", flexDirection: "column", gap: "1rem" }} onSubmit={handleSubmit}>
              <label>
                <div style={{ fontSize: ".75rem", fontWeight: 500, textTransform: "uppercase", letterSpacing: ".025em", color: "rgba(17,17,17,.5)" }}>Name</div>
                <input
                  type="text"
                  required
                  ...
                  style={{ width: "100%", border: "1px solid #e6e5e2", background: "rgba(241,240,238,.5)", borderRadius: ".875rem", padding: ".75rem 1rem", fontSize: ".875rem", outline: "none", transition: "border .2s, background .2s" }}
                />
              </label>

              <label>
                <div style={{ fontSize: ".75rem", fontWeight: 500, textTransform: "uppercase", letterSpacing: ".025em", color: "rgba(17,17,17,.5)" }}>Email</div>
                <input
                  type="email"
                  required
              ...
              <label>
                <div style={{ fontSize: ".75rem", fontWeight: 500, textTransform: "uppercase", letterSpacing: ".025em", color: "rgba(17,17,17,.5)" }}>Inquiry</div>
                <textarea
                  rows={4}
                  required
                  ...
                  style={{ width: "100%", border: "1px solid #e6e5e2", background: "rgba(241,240,238,.5)", borderRadius: ".875rem", padding: ".75rem 1rem", fontSize: ".875rem", outline: "none", resize: "none", transition: "border .2s, background .2s" }}
                />
              </label>

              <div style={{ marginTop: ".5rem", display: "flex", alignItems: "center", justifyContent: "space-between", gap: "1rem" }}>
                <span style={{ fontSize: ".75rem", color: "rgba(17,17,17,.45)" }}>We reply within one business day.</span>
                <button type="submit" className="pill-btn" disabled={isSubmitting}>
                  <span className="pill-inner pill-dark pill-with-arrow">
